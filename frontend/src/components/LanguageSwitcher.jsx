...
export default function LanguageSwitcher({ transparent = false }) {
  ...
  return (
    <div
      className={`inline-flex items-center h-10 gap-1.5 rounded-xl border px-2.5 transition-all duration-300 ${
        transparent
    ...
    >
      <Languages size={15} className={transparent ? "text-slate-200" : "text-slate-500 dark:text-slate-400"} />
      <button
        type="button"
