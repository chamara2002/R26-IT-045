...
export default function ForgotPasswordPage() {
  ...
  // Step state: 1 = Enter Email, 2 = Enter 6-Digit OTP, 3 = New Password, 4 = Success
  ...
  // Mask email for privacy (e.g. f***r@example.com)
  const maskEmail = (str) => {
  ...
  const handleResendOtp = async () => {
    ...
    try {
      ...
      setSuccessInfo(res?.message || "A new 6-digit verification code has been sent.");
      setCountdown(60);
      setCanResend(false);
      setOtpDigits(["", "", "", "", "", ""]);
  ...
  return (
    <PageWrapper className="min-h-screen relative flex items-center justify-center p-4 sm:p-6 lg:p-10 overflow-hidden bg-slate-950">
      ...
      >
        {/* Left Side - Clean & Minimal Emerald Branding (Identical to Login / Signup) */}
          ...
          <div>
            ...
            <div className="mb-6 flex flex-col items-center text-center">
              ...
              <p className="text-xs text-slate-500 dark:text-slate-400 max-w-sm">
                ...
                {step === 2 && `Enter the 6-digit verification code sent to ${maskEmail(email)}.`}
            ...
            {step === 4 && (
              <div className="text-center py-4 space-y-4">
                ...
                <p className="text-xs sm:text-sm text-slate-600 dark:text-slate-400 leading-relaxed max-w-sm mx-auto">
                  Your password has been updated securely. You can now sign in to your CattleSense workspace with your new password.
                </p>
