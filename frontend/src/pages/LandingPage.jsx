    ...
    <div className="min-h-screen bg-slate-50 text-slate-900 dark:bg-slate-950 dark:text-white transition-colors duration-300">
              ...
              <>
                ...
                <div className="relative">
                  <button
                    ...
                    className="flex items-center gap-2 p-2 hover:bg-slate-100 dark:hover:bg-white/8 rounded-lg transition-colors"
                  >
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="absolute inset-0 overflow-hidden pointer-events-none">
          <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-emerald-500/15 dark:bg-emerald-500/10 rounded-full blur-3xl" />
          <div className="absolute top-1/3 right-1/4 w-80 h-80 bg-teal-500/15 dark:bg-teal-500/8 rounded-full blur-3xl" />
          <div className="absolute bottom-0 left-1/2 w-64 h-64 bg-violet-500/15 dark:bg-violet-500/8 rounded-full blur-3xl" />
        </div>
        ...
        <div className="relative mx-auto max-w-7xl px-4 py-24 sm:px-6 sm:py-32 lg:px-8">
          <motion.div initial="hidden" animate="visible" variants={containerVariants} className="text-center">
            ...
            <motion.div variants={itemVariants} className="mb-8">
              <div className="inline-flex items-center gap-2 rounded-full border border-emerald-300 dark:border-emerald-500/50 bg-emerald-100 dark:bg-emerald-950/80 px-5 py-2.5 text-sm font-bold text-emerald-900 dark:text-emerald-200 shadow-xs dark:shadow-emerald-950/50 backdrop-blur">
                <Stethoscope className="h-4 w-4 text-emerald-600 dark:text-emerald-400" />
                AI-Powered Cattle Health Platform
              </div>
            </motion.div>

            <motion.h1
              variants={itemVariants}
              className="mx-auto mb-6 max-w-5xl text-5xl font-black leading-[1] tracking-tight sm:text-6xl lg:text-7xl text-slate-900 dark:text-white"
            >
              Early Detection of{' '}
            ...
            <motion.p
              variants={itemVariants}
              className="mx-auto mb-4 max-w-3xl text-lg text-slate-600 dark:text-slate-400 sm:text-xl leading-relaxed"
            >
              CattleSense gives farmers an easy way to check for serious cattle diseases — just upload a photo,
              answer a few questions, and get an AI-powered result in seconds.
            </motion.p>

            <motion.div variants={itemVariants} className="flex flex-wrap justify-center gap-3 mb-12">
              {['4 Disease Health Checks', 'Image + Clinical AI', 'Early Detection', 'Farmer Friendly'].map(tag => (
                <span key={tag} className="inline-flex items-center gap-1.5 rounded-full border border-slate-200 dark:border-white/10 bg-white/80 dark:bg-white/5 px-4 py-1.5 text-sm font-medium text-slate-700 dark:text-slate-300 shadow-xs dark:shadow-none">
            ...
            <motion.div variants={itemVariants} className="flex flex-col justify-center gap-4 sm:flex-row">
              {isLoggedIn ? (
                <Link
                  to="/modules"
                  className="inline-flex items-center justify-center gap-2 rounded-2xl bg-gradient-to-r from-emerald-500 to-emerald-600 px-8 py-4 font-bold text-white transition-all duration-300 hover:from-emerald-600 hover:to-emerald-700 hover:shadow-xl hover:shadow-emerald-500/30 text-base"
                >
                ...
                <>
                  ...
                  <a
                    href="#modules"
                    className="inline-flex items-center justify-center gap-2 rounded-2xl border-2 border-slate-300 dark:border-white/20 px-8 py-4 font-bold text-slate-700 dark:text-white transition hover:border-emerald-600 hover:text-emerald-600 dark:hover:border-emerald-400 dark:hover:text-emerald-400 text-base"
                  >
                    See Disease Checks
                  </a>
                </>
