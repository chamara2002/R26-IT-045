    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <select name="parity" value={form.parity} onChange={onChange}
          className={`w-full rounded-xl border border-slate-300 dark:border-slate-600 bg-white dark:bg-slate-800 px-4 py-3 text-slate-900 dark:text-slate-100 text-sm focus:outline-none focus:ring-2 ${color.ring}`}>
          <option value="">-- Select --</option>
      ...
      <div className="space-y-2">
        ...
        <label className="flex items-center gap-3 rounded-xl border border-slate-200 dark:border-slate-700 p-3 cursor-pointer hover:border-slate-300 dark:hover:border-slate-600 transition-colors">
